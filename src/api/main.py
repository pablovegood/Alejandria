...
# ============================================================
# Observabilidad (metrics + tracing opcional)
# ============================================================
...
if not HAS_FRONTEND:
    logger.error("❌ STATIC_DIR no existe. Arrancando en modo API-only: %s", STATIC_DIR)
else:
    logger.info("✅ Serviremos frontend estático desde: %s", STATIC_DIR)
